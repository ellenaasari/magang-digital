    ...
    <div id="main" class="pt-0 mt-0 ml-1 px-4 ">
        <div class="row">
            ...
            <div class="col-12 col-md-6 order-md-1 mb-0 order-last">
                <div class="m-0 pt-2 ">
                    <h3 class="m-0 p-0 text-white">Daftar Pembina</h3>
                    <p class="text-white-50">Table seluruh data pembina yang tersedia</p>
                </div>
            </div>
            ...
            <div class="col-12 mt-3 col-md-6 order-md-2 order-first d-sm-none d-lg-inline">
                <nav class="breadcrumb-header float-lg-end" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a class="text-white" href="">Pembina</a></li>
                        <li class="text-white-50 breadcrumb-item active">Daftar Pendaftar</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card-body pt-4 m-0">
                <div class="table-responsive">
                    <table class="table" id="table">
                        ...
                        <tbody>
                            @foreach ($daftarPembina as $pendaftar)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $pendaftar->name }}</td>
                                    <td>{{ $pendaftar->extracurricular_leader_for }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
